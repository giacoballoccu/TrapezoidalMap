...
public:
    ...
    {
        TrapezoidalMapManager->setWindowTitle(QCoreApplication::translate("TrapezoidalMapManager", "Frame", nullptr));
        randomSegmentsButton->setText(QCoreApplication::translate("TrapezoidalMapManager", "Random", nullptr));
        queryTimeDescriptionLabel->setText(QCoreApplication::translate("TrapezoidalMapManager", "Time:", nullptr));
        loadSegmentsTimeLabel->setText(QString());
        loadSegmentsButton->setText(QCoreApplication::translate("TrapezoidalMapManager", "Load", nullptr));
        addSegmentTimeLabel->setText(QString());
        addSegmentRadio->setText(QCoreApplication::translate("TrapezoidalMapManager", "Add segment", nullptr));
        addSegmentTimeDescriptionLabel->setText(QCoreApplication::translate("TrapezoidalMapManager", "Time:", nullptr));
        loadSegmentsTimeDescriptionLabel->setText(QCoreApplication::translate("TrapezoidalMapManager", "Time:", nullptr));
        queryRadio->setText(QCoreApplication::translate("TrapezoidalMapManager", "Query", nullptr));
        queryTimeLabel->setText(QString());
        saveSegmentsButton->setText(QCoreApplication::translate("TrapezoidalMapManager", "Save", nullptr));
        clearSegmentsButton->setText(QCoreApplication::translate("TrapezoidalMapManager", "Clear", nullptr));
        resetSceneButton->setText(QCoreApplication::translate("TrapezoidalMapManager", "Reset scene", nullptr));
        numberRandomLabel->setText(QCoreApplication::translate("TrapezoidalMapManager", "Number random:", nullptr));
    } // retranslateUi
